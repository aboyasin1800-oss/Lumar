...
public sealed record OrderListDto(int OrderId, string OrderNumber, int CustomerId, DateTime OrderDate, DateTime? DeliveryDate, decimal TotalAmount, decimal PaidAmount, decimal RemainingAmount, string UrgencyStatus, string OrderStatus, string SaleCategory);
public sealed record OrderDetailsDto(int OrderId, string OrderNumber, int CustomerId, DateTime OrderDate, DateTime? DeliveryDate, decimal TotalAmount, decimal DiscountAmount, decimal PaidAmount, decimal RemainingAmount, string UrgencyStatus, string OrderStatus, string? Notes, DateTime CreatedDate, DateTime? UpdatedDate, string? CancellationReason, DateTime? CancelledAt, string? CancelledBy, string SaleCategory, bool RevenueRecognized, DateTime? RevenueRecognizedAt, bool RevenueReversalCreated, DateTime? RevenueReversalCreatedAt);
