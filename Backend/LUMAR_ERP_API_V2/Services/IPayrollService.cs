...
public interface IPayrollService
{
    ...
    Task<IReadOnlyList<PayrollItemDto>> GetItemsAsync(int id, CancellationToken ct);
    Task<IReadOnlyList<EmployeePayrollSummaryDto>> GetEmployeeSummariesAsync(int id, CancellationToken ct);
